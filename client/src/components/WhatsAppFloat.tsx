...
export default function WhatsAppFloat() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      {showTooltip && (
        <div className="bg-white rounded-2xl shadow-xl border border-border p-3 max-w-[200px] relative animate-fade-up">
          <button
          ...
          <p className="font-body text-xs text-foreground font-medium">Agende pelo WhatsApp! 💆‍♀️</p>
          <p className="font-body text-xs text-muted-foreground mt-0.5">(19) 99881-3701</p>
        </div>
      )}
      <a
